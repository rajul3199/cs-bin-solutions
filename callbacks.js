...
// /*** Uncomment these to check your work! ***/
const isOdds = function(num) { return num % 2 === 1; };
...
function prioritize(array, callback) {
  ...
  sArray.forEach(e => newArray.push(e));
  return newArray;
}
...
function commutative(func1, func2, value) {
	let value1 = func2(func1(value));
  let value2 = func1(func2(value));
  if(value1 === value2)
    return true;
  return false;
}
